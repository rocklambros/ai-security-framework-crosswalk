...
source_file: "LLMAll_en-US_FINAL.pdf"
pages: 45
type: pdf
---
...
[genai.owasp.org](https://genai.owasp.org/) 1
...
[genai.owasp.org](https://genai.owasp.org/) 2
...
[genai.owasp.org](https://genai.owasp.org/) 3


which the model is architected. Generally, however, prompt injection can lead to unintendedOWASP Top 10 for LLM Applications v2.0
...
attacks that are difficult to detect and mitigate with current techniques. Robust multimodalspecific defenses are an important area for further research and development.
...
[genai.owasp.org](https://genai.owasp.org/) 4


Implement human-in-the-loop controls for privileged operations to prevent unauthorizedOWASP Top 10 for LLM Applications v2.0
actions.
...
[genai.owasp.org](https://genai.owasp.org/) 5
...
influences the LLM's output in a malicious way, bypassing safety measures.OWASP Top 10 for LLM Applications v2.0
...
[1. ChatGPT Plugin Vulnerabilities - Chat with Code Embrace the Red](https://embracethered.com/blog/posts/2023/chatgpt-plugin-vulns-chat-with-code/)
[2. ChatGPT Cross Plugin Request Forgery and Prompt Injection Embrace the Red](https://embracethered.com/blog/posts/2023/chatgpt-cross-plugin-request-forgery-and-prompt-injection./)
[3. Not what you’ve signed up for: Compromising Real-World LLM-Integrated Applications](https://arxiv.org/pdf/2302.12173.pdf)

[with Indirect Prompt Injection Arxiv](https://arxiv.org/pdf/2302.12173.pdf)
[4. Defending ChatGPT against Jailbreak Attack via Self-Reminder Research Square](https://www.researchsquare.com/article/rs-2873090/v1)
[5. Prompt Injection attack against LLM-integrated Applications Cornell University](https://arxiv.org/abs/2306.05499)
[6. Inject My PDF: Prompt Injection for your Resume Kai Greshake](https://kai-greshake.de/posts/inject-my-pdf)
[8. Not what you’ve signed up for: Compromising Real-World LLM-Integrated Applications](https://arxiv.org/pdf/2302.12173.pdf)

[with Indirect Prompt Injection Cornell University](https://arxiv.org/pdf/2302.12173.pdf)
[9. Threat Modeling LLM Applications AI Village](https://aivillage.org/large%20language%20models/threat-modeling-llm/)
[10. Reducing The Impact of Prompt Injection Attacks Through Design Kudelski Security](https://research.kudelskisecurity.com/2023/05/25/reducing-the-impact-of-prompt-injection-attacks-through-design/)

[11. Adversarial Machine Learning: A Taxonomy and Terminology of Attacks and Mitigations](https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.100-2e2023.pdf)

[(nist.gov)](https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.100-2e2023.pdf)
[12. 2407.07403 A Survey of Attacks on Large Vision-Language Models: Resources, Advances,](https://arxiv.org/abs/2407.07403)

[and Future Trends (arxiv.org)](https://arxiv.org/abs/2407.07403)
[13. Exploiting Programmatic Behavior of LLMs: Dual-Use Through Standard Security Attacks](https://ieeexplore.ieee.org/document/10579515)
[14. Universal and Transferable Adversarial Attacks on Aligned Language Models (arxiv.org)](https://arxiv.org/abs/2307.15043)
[15. From ChatGPT to ThreatGPT: Impact of Generative AI in Cybersecurity and Privacy](https://arxiv.org/abs/2307.00691)

[(arxiv.org)](https://arxiv.org/abs/2307.00691)
...
[genai.owasp.org](https://genai.owasp.org/) 6
...
or reconstruct inputs. For instance, as demonstrated in the 'Proof Pudding' attack (CVE-201920634), disclosed training data facilitated model extraction and inversion, allowing attackers
...
[genai.owasp.org](https://genai.owasp.org/) 7
...
[genai.owasp.org](https://genai.owasp.org/) 8


of exposure to internal configurations.


[(Ref. link:OWASP API8:2023 Security Misconfiguration)OWASP Top 10 for LLM Applications v2.0](https://owasp.org/API-Security/editions/2023/en/0xa8-security-misconfiguration/)
...
[2. AI data leak crisis: New tool prevents company secrets from being fed to ChatGPT: Fox](https://www.foxbusiness.com/politics/ai-data-leak-crisis-prevent-company-secrets-chatgpt)

[Business](https://www.foxbusiness.com/politics/ai-data-leak-crisis-prevent-company-secrets-chatgpt)
[3. ChatGPT Spit Out Sensitive Data When Told to Repeat ‘Poem’ Forever: Wired](https://www.wired.com/story/chatgpt-poem-forever-security-roundup/)
[4. Using Differential Privacy to Build Secure Models: Neptune Blog](https://neptune.ai/blog/using-differential-privacy-to-build-secure-models-tools-methods-best-practices)
[5. Proof Pudding (CVE-2019-20634) AVID (`moohax` & `monoxgas`)](https://avidml.org/database/avid-2023-v009/)
...
[• AML.T0024.000 - Infer Training Data Membership MITRE ATLAS](https://atlas.mitre.org/techniques/AML.T0024.000)


[genai.owasp.org](https://genai.owasp.org/) 9


OWASP Top 10 for LLM Applications v2.0


[genai.owasp.org](https://genai.owasp.org/) 10
...
[genai.owasp.org](https://genai.owasp.org/) 11


**4. Vulnerable Pre-Trained Model**


model tampering using tehcniques such as ROME also known as lobotomisation.OWASP Top 10 for LLM Applications v2.0
...
risks, where a malicious LorA adapter compromises the integrity and security of the pretrained base model. This can happen both in collaborative model merge environments but
...
[genai.owasp.org](https://genai.owasp.org/) 12


controls in those environments, too.


Decoding Trust is an example of a Trustworthy AI benchmark for LLMs but models canOWASP Top 10 for LLM Applications v2.0
...
[genai.owasp.org](https://genai.owasp.org/) 13
...
with PoisonGPT bypassing Hugging Face safety features by directly changing modelOWASP Top 10 for LLM Applications v2.0
parameters.
...
An attacker infiltrates a third-party supplier and compromises the production of a LoRA (LowRank Adaptation) adapter intended for integration with an on-device LLM deployed using
...
[genai.owasp.org](https://genai.owasp.org/) 14


published by vendor HiddenLayer.


An attacker reverse-engineers an mobile app to replace the model with a tampered versionOWASP Top 10 for LLM Applications v2.0
...
[genai.owasp.org](https://genai.owasp.org/) 15
...
[genai.owasp.org](https://genai.owasp.org/) 16
...
[genai.owasp.org](https://genai.owasp.org/) 17
...
[2. MITRE ATLAS (framework) Tay Poisoning: MITRE ATLAS](https://atlas.mitre.org/studies/AML.CS0009/)
[3. PoisonGPT: How we hid a lobotomized LLM on Hugging Face to spread fake news: Mithril](https://blog.mithrilsecurity.io/poisongpt-how-we-hid-a-lobotomized-llm-on-hugging-face-to-spread-fake-news/)

[Security](https://blog.mithrilsecurity.io/poisongpt-how-we-hid-a-lobotomized-llm-on-hugging-face-to-spread-fake-news/)
[4. Poisoning Language Models During Instruction: Arxiv White Paper 2305.00944](https://arxiv.org/abs/2305.00944)
[5. Poisoning Web-Scale Training Datasets - Nicholas Carlini | Stanford MLSys #75: Stanford](https://www.youtube.com/watch?v=h9jf1ikcGyk)

[MLSys Seminars YouTube Video](https://www.youtube.com/watch?v=h9jf1ikcGyk)
[6. ML Model Repositories: The Next Big Supply Chain Attack Target OffSecML](https://www.darkreading.com/cloud-security/ml-model-repositories-next-big-supply-chain-attack-target)

[7. Data Scientists Targeted by Malicious Hugging Face ML Models with Silent Backdoor](https://jfrog.com/blog/data-scientists-targeted-by-malicious-hugging-face-ml-models-with-silent-backdoor/)

[JFrog](https://jfrog.com/blog/data-scientists-targeted-by-malicious-hugging-face-ml-models-with-silent-backdoor/)
[8. Backdoor Attacks on Language Models: Towards Data Science](https://towardsdatascience.com/backdoor-attacks-on-language-models-can-we-trust-our-models-weights-73108f9dcb1f)
[9. Never a dill moment: Exploiting machine learning pickle files TrailofBits](https://blog.trailofbits.com/2021/03/15/never-a-dill-moment-exploiting-machine-learning-pickle-files/)
[10. arXiv:2401.05566 Sleeper Agents: Training Deceptive LLMs that Persist Through Safety](https://www.anthropic.com/news/sleeper-agents-training-deceptive-llms-that-persist-through-safety-training)

[Training Anthropic (arXiv)](https://www.anthropic.com/news/sleeper-agents-training-deceptive-llms-that-persist-through-safety-training)
[11. Backdoor Attacks on AI Models Cobalt](https://www.cobalt.io/blog/backdoor-attacks-on-ai-models)
...
[• AML.T0018 | Backdoor ML Model MITRE ATLAS](https://atlas.mitre.org/techniques/AML.T0018)

[• NIST AI Risk Management Framework: Strategies for ensuring AI integrity. NIST](https://www.nist.gov/itl/ai-risk-management-framework)


[genai.owasp.org](https://genai.owasp.org/) 18
...
[genai.owasp.org](https://genai.owasp.org/) 19
...
[genai.owasp.org](https://genai.owasp.org/) 20


**Scenario # 5**


**Scenario #6** OWASP Top 10 for LLM Applications v2.0
...
[1. Proof Pudding (CVE-2019-20634) AVID (`moohax` & `monoxgas`)](https://avidml.org/database/avid-2023-v009/)
[2. Arbitrary Code Execution: Snyk Security Blog](https://security.snyk.io/vuln/SNYK-PYTHON-LANGCHAIN-5411357)
...
[Embrace The Red](https://embracethered.com/blog/posts/2023/chatgpt-cross-plugin-request-forgery-and-prompt-injection./)
[4. New prompt injection attack on ChatGPT web version. Markdown images can steal your](https://systemweakness.com/new-prompt-injection-attack-on-chatgpt-web-version-ef717492c5c2?gi=8daec85e2116)

[chat data.: System Weakness](https://systemweakness.com/new-prompt-injection-attack-on-chatgpt-web-version-ef717492c5c2?gi=8daec85e2116)
[5. Don’t blindly trust LLM responses. Threats to chatbots: Embrace The Red](https://embracethered.com/blog/posts/2023/ai-injections-threats-context-matters/)
[6. Threat Modeling LLM Applications: AI Village](https://aivillage.org/large%20language%20models/threat-modeling-llm/)

[7. OWASP ASVS - 5 Validation, Sanitization and Encoding: OWASP AASVS](https://owasp-aasvs4.readthedocs.io/en/latest/V5.html#validation-sanitization-and-encoding)
[8. AI hallucinates software packages and devs download them – even if potentially](https://www.theregister.com/2024/03/28/ai_bots_hallucinate_software_packages/)

[poisoned with malware Theregiste](https://www.theregister.com/2024/03/28/ai_bots_hallucinate_software_packages/)


[genai.owasp.org](https://genai.owasp.org/) 21
...
[genai.owasp.org](https://genai.owasp.org/) 22


**2. Excessive Functionality**

An extension may have been trialled during a development phase and dropped in favor of aOWASP Top 10 for LLM Applications v2.0
...
[genai.owasp.org](https://genai.owasp.org/) 23


writing extension that only implements that specific functionality.OWASP Top 10 for LLM Applications v2.0
...
[genai.owasp.org](https://genai.owasp.org/) 24
...
[1. Slack AI data exfil from private channels: PromptArmor](https://promptarmor.substack.com/p/slack-ai-data-exfiltration-from-private)
[2. Rogue Agents: Stop AI From Misusing Your APIs: Twilio](https://www.twilio.com/en-us/blog/rogue-ai-agents-secure-your-apis)
[3. Embrace the Red: Confused Deputy Problem: Embrace The Red](https://embracethered.com/blog/posts/2023/chatgpt-cross-plugin-request-forgery-and-prompt-injection./)
[4. NeMo-Guardrails: Interface guidelines: NVIDIA Github](https://github.com/NVIDIA/NeMo-Guardrails/blob/main/docs/security/guidelines.md)
[6. Simon Willison: Dual LLM Pattern: Simon Willison](https://simonwillison.net/2023/Apr/25/dual-llm-pattern/)


[genai.owasp.org](https://genai.owasp.org/) 25
...
[genai.owasp.org](https://genai.owasp.org/) 26


**2. Exposure of Internal Rules**


and its system prompt may reveal information likeOWASP Top 10 for LLM Applications v2.0
...
[genai.owasp.org](https://genai.owasp.org/) 27
...
[1. SYSTEM PROMPT LEAK: Pliny the prompter](https://x.com/elder_plinius/status/1801393358964994062)
[2. Prompt Leak: Prompt Security](https://www.prompt.security/vulnerabilities/prompt-leak)
[3. chatgpt_system_prompt: LouisShark](https://github.com/LouisShark/chatgpt_system_prompt)
[4. leaked-system-prompts: Jujumilk3](https://github.com/jujumilk3/leaked-system-prompts)
[5. OpenAI Advanced Voice Mode System Prompt: Green_Terminals](https://x.com/Green_terminals/status/1839141326329360579)
...
[• AML.T0051.000 - LLM Prompt Injection: Direct (Meta Prompt Extraction) MITRE ATLAS](https://atlas.mitre.org/techniques/AML.T0051.000)


[genai.owasp.org](https://genai.owasp.org/) 28
...
[genai.owasp.org](https://genai.owasp.org/) 29


**5. Behavior Alteration**


certain applications. (Scenario #3)OWASP Top 10 for LLM Applications v2.0
...
[genai.owasp.org](https://genai.owasp.org/) 30


**Mitigation**


that only authorized groups can access their specific information.OWASP Top 10 for LLM Applications v2.0
...
[1. Augmenting a Large Language Model with Retrieval-Augmented Generation and Fine-](https://learn.microsoft.com/en-us/azure/developer/ai/augment-llm-rag-fine-tuning)

[tuning](https://learn.microsoft.com/en-us/azure/developer/ai/augment-llm-rag-fine-tuning)
[2. Astute RAG: Overcoming Imperfect Retrieval Augmentation and Knowledge Conflicts for](https://arxiv.org/abs/2410.07176)

[Large Language Models](https://arxiv.org/abs/2410.07176)
[3. Information Leakage in Embedding Models](https://arxiv.org/abs/2004.00053)
[4. Sentence Embedding Leaks More Information than You Expect: Generative Embedding](https://arxiv.org/pdf/2305.03010)

[Inversion Attack to Recover the Whole Sentence](https://arxiv.org/pdf/2305.03010)
...
[genai.owasp.org](https://genai.owasp.org/) 31
...
A related issue is overreliance. Overreliance occurs when users place excessive trust in LLMgenerated content, failing to verify its accuracy. This overreliance exacerbates the impact of
...
[genai.owasp.org](https://genai.owasp.org/) 32


[(Ref. link: KFF)](https://www.kff.org/health-misinformation-monitor/volume-05/)
**4. Unsafe Code Generation**

The model suggests insecure or non-existent code libraries, which can introduceOWASP Top 10 for LLM Applications v2.0
...
[genai.owasp.org](https://genai.owasp.org/) 33
...
[1. AI Chatbots as Health Information Sources: Misrepresentation of Expertise: KFF](https://www.kff.org/health-misinformation-monitor/volume-05/)
[2. Air Canada Chatbot Misinformation: What Travellers Should Know: BBC](https://www.bbc.com/travel/article/20240222-air-canada-chatbot-misinformation-what-travellers-should-know)
[3. ChatGPT Fake Legal Cases: Generative AI Hallucinations: LegalDive](https://www.legaldive.com/news/chatgpt-fake-legal-cases-generative-ai-hallucinations/651557/)
[4. Understanding LLM Hallucinations: Towards Data Science](https://towardsdatascience.com/llm-hallucinations-ec831dcd7786)
[5. How Should Companies Communicate the Risks of Large Language Models to Users?:](https://techpolicy.press/how-should-companies-communicate-the-risks-of-large-language-models-to-users/)

[Techpolicy](https://techpolicy.press/how-should-companies-communicate-the-risks-of-large-language-models-to-users/)
[6. A news site used AI to write articles. It was a journalistic disaster: Washington Post](https://www.washingtonpost.com/media/2023/01/17/cnet-ai-articles-journalism-corrections/)

[7. Diving Deeper into AI Package Hallucinations: Lasso Security](https://www.lasso.security/blog/ai-package-hallucinations)
[8. How Secure is Code Generated by ChatGPT?: Arvix](https://arxiv.org/abs/2304.09655)
[9. How to Reduce the Hallucinations from Large Language Models: The New Stack](https://thenewstack.io/how-to-reduce-the-hallucinations-from-large-language-models/)
[10. Practical Steps to Reduce Hallucination: Victor Debia](https://newsletter.victordibia.com/p/practical-steps-to-reduce-hallucination)

[11. A Framework for Exploring the Consequences of AI-Mediated Enterprise Knowledge:](https://www.microsoft.com/en-us/research/publication/a-framework-for-exploring-the-consequences-of-ai-mediated-enterprise-knowledge-access-and-identifying-risks-to-workers/)

[Microsoft](https://www.microsoft.com/en-us/research/publication/a-framework-for-exploring-the-consequences-of-ai-mediated-enterprise-knowledge-access-and-identifying-risks-to-workers/)
...
[• AML.T0048.002 - Societal Harm MITRE ATLAS](https://atlas.mitre.org/techniques/AML.T0048)


[genai.owasp.org](https://genai.owasp.org/) 34
...
By initiating a high volume of operations, attackers exploit the cost-per-use model of cloudbased AI services, leading to unsustainable financial burdens on the provider and risking
financial ruin.
...
[genai.owasp.org](https://genai.owasp.org/) 35
...
another foundational model, creating a functional equivalent. This circumvents traditionalOWASP Top 10 for LLM Applications v2.0
...
[genai.owasp.org](https://genai.owasp.org/) 36


rather than complete failure.


consistent system performance.OWASP Top 10 for LLM Applications v2.0
...
[genai.owasp.org](https://genai.owasp.org/) 37
...
[1. Proof Pudding (CVE-2019-20634) AVID (`moohax` & `monoxgas`)](https://avidml.org/database/avid-2023-v009/)
[2. arXiv:2403.06634 Stealing Part of a Production Language Model arXiv](https://arxiv.org/abs/2403.06634)
[3. Runaway LLaMA | How Meta's LLaMA NLP model leaked: Deep Learning Blog](https://www.deeplearning.ai/the-batch/how-metas-llama-nlp-model-leaked/)
[4. I Know What You See:: Arxiv White Paper](https://arxiv.org/pdf/1803.05847.pdf)
[5. A Comprehensive Defense Framework Against Model Extraction Attacks: IEEE](https://ieeexplore.ieee.org/document/10080996)
[6. Alpaca: A Strong, Replicable Instruction-Following Model: Stanford Center on Research](https://crfm.stanford.edu/2023/03/13/alpaca.html)

[for Foundation Models (CRFM)](https://crfm.stanford.edu/2023/03/13/alpaca.html)
[7. How Watermarking Can Help Mitigate The Potential Risks Of LLMs?: KD Nuggets](https://www.kdnuggets.com/2023/03/watermarking-help-mitigate-potential-risks-llms.html)
[8. Securing AI Model Weights Preventing Theft and Misuse of Frontier Models](https://www.rand.org/content/dam/rand/pubs/research_reports/RRA2800/RRA2849-1/RAND_RRA2849-1.pdf)
[9. Sponge Examples: Energy-Latency Attacks on Neural Networks: Arxiv White Paper arXiv](https://arxiv.org/abs/2006.03463)
[10. Sourcegraph Security Incident on API Limits Manipulation and DoS Attack Sourcegraph](https://about.sourcegraph.com/blog/security-update-august-2023)
...
[• MITRE CWE-400: Uncontrolled Resource Consumption MITRE Common Weakness](https://cwe.mitre.org/data/definitions/400.html)

[Enumeration](https://cwe.mitre.org/data/definitions/400.html)

[• AML.TA0000 ML Model Access: Mitre ATLAS & AML.T0024 Exfiltration via ML Inference API](https://atlas.mitre.org/tactics/AML.TA0000)

[MITRE ATLAS](https://atlas.mitre.org/tactics/AML.TA0000)

[• AML.T0029 - Denial of ML Service MITRE ATLAS](https://atlas.mitre.org/techniques/AML.T0029)

[• AML.T0034 - Cost Harvesting MITRE ATLAS](https://atlas.mitre.org/techniques/AML.T0034)

[• AML.T0025 - Exfiltration via Cyber Means MITRE ATLAS](https://atlas.mitre.org/techniques/AML.T0025)

[• OWASP Machine Learning Security Top Ten - ML05:2023 Model Theft OWASP ML Top 10](https://owasp.org/www-project-machine-learning-security-top-10/docs/ML05_2023-Model_Theft.html)

[• API4:2023 - Unrestricted Resource Consumption OWASP Web Application Top 10](https://owasp.org/API-Security/editions/2023/en/0xa4-unrestricted-resource-consumption/)

[• OWASP Resource Management OWASP Secure Coding Practices](https://owasp.org/www-project-secure-coding-practices-quick-reference-guide/)


[genai.owasp.org](https://genai.owasp.org/) 38


##### **Appendix 1: LLM Application Architecture and Threat Modeling**

[genai.owasp.org](https://genai.owasp.org/) 39


[genai.owasp.org](https://genai.owasp.org/) 40


[genai.owasp.org](https://genai.owasp.org/) 41
