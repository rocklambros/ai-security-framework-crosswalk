"""B2.13: B-2 frozen test set evaluation (aiuc_1 -> csa_aicm).

Touched ONCE. NO retuning afterwards.
"""
...
def main() -> None:
    ...
    print(f"B-2 frozen test: {PAIR}  n={len(g)}")
    ...
    out_path = REPO / "data" / "processed" / "frozen_test_b2.json"
